<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/index/index.htm";i:1689946980;s:73:"/Users/gjj/hzwork/eyoucms/application/admin/template/public/theme_css.htm";i:1689649653;s:71:"/Users/gjj/hzwork/eyoucms/application/admin/template/public/menubox.htm";i:1689649653;s:68:"/Users/gjj/hzwork/eyoucms/application/admin/template/public/left.htm";i:1689946635;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="btn-group pull-left ey-tool">
              ...
              <em class="eyou_tool em_diyminipro" data-expanded="close">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="shouquan">
                    ...
                    <li class="ey-tool-list text-center"><a class="liaojie" href="<?php echo weapp_url($vo['code'].'/'.$vo['code'].'/page_edit'); ?>" target="_blank" onclick="$('.em_diyminipro').toggleClass('open');"><?php echo $vo['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
               </em>
              <?php endif; ?>
